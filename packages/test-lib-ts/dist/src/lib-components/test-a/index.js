...
const __vue_inject_styles__ = function (inject) {
  if (!inject) return;
  inject("data-v-b1c87448_0", {
    source: ".test-lib-ts-sample[data-v-b1c87448]{display:block;width:400px;margin:25px auto;border:1px solid #ccc;background:#eaeaea;text-align:center;padding:25px}.test-lib-ts-sample p[data-v-b1c87448]{margin:0 0 1em}",
    map: undefined,
    media: undefined
  });
};
...
const __vue_scope_id__ = "data-v-b1c87448";
/* module identifier */
